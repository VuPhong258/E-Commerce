  ...
  return (
    <Container className="relative py-5 overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10">
        ...
        <p
          className="text-base md:text-lg font-semibold leading-6 text-whiteText/90
        max-w-[250px] mt-4 "
        >
          The new tech gift you are wishing for right here.
        </p>
        <LinkButton
          className="w-44 flex items-center justify-center bg-white text-darkText
        hover:bg-darkText hover:text-whiteText duration-200 mt-4"
        />
      </div>
    </Container>
  );
